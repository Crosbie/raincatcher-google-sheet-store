var sheetsApi = require('./google-sheets');
 ...
 * @constructor
 */
function GoogleSheetStore(datasetId, sheetId, entitySchema) {
 ...
 * @returns {Object}
 */
GoogleSheetStore.prototype.convertJSONEntityToRow = function convertJSONEntityToRow(jsonEntity) {
 ...
 * @returns {Object}
 */
GoogleSheetStore.prototype.convertRowEntityToJSON = function convertRowEntityToJSON(rowEntity) {
 ...
 * @returns {*}
 */
GoogleSheetStore.prototype.init = function init(seedData) {
  var self = this;
  seedData = seedData || [];
...
/**
 *
 * Returning the Google Sheet related to this data set.
 *
 * @returns {Promise}
 */
GoogleSheetStore.prototype.getSheet = function getSheet() {
  return sheetsApi.getWorksheet(this.sheetId);
};
 ...
 * @returns {Promise}
 */
GoogleSheetStore.prototype.create = function create(entity) {
  var self = this;
 ...
 * @returns {Promise}
 */
GoogleSheetStore.prototype.read = function read(id) {
  var self = this;
  return this.getSheet().then(function(sheet) {
 ...
 * @returns {Promise}
 */
GoogleSheetStore.prototype.update = function update(entity) {
  var self = this;
  entity = self.convertJSONEntityToRow(entity);
  return this.getSheet().then(function(sheet) {
 ...
 * @returns {Promise}
 */
GoogleSheetStore.prototype.remove = function remove(id) {
  return this.getSheet().then(function(sheet) {
 ...
 * @returns {Promise}
 */
GoogleSheetStore.prototype.list = function list(filter) {
  filter = filter || {};
  var self = this;
  return this.getSheet().then(function(sheet) {
 ...
 */
GoogleSheetStore.prototype.listen = function(topicPrefix, mediator) {
...
module.exports = GoogleSheetStore;